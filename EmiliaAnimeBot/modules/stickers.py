...
Credit = "This Plugin Made For Minato , if you're using this code in your bot. there is no issue but don't remove this line" 
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./EmiliaAnimeBot/resources/ASTERAV2.ttf"
